...
export const api = {
  ...
  updateObjective: (id, data) => request('PATCH', `/objectives/${id}`, data),
  setObjectiveHealth: (id, health, reason) => request('POST', `/objectives/${id}/health`, { health, reason }),
  archiveObjective: (id) => request('DELETE', `/objectives/${id}`),
  addKeyResult: (objectiveId, data) => request('POST', `/objectives/${objectiveId}/key-results`, data),
  equaliseWeights: (objectiveId) => request('POST', `/objectives/${objectiveId}/key-results/equalise-weights`),

  keyResults: (params) => request('GET', `/key-results${qs(params)}`),
  keyResult: (id) => request('GET', `/key-results/${id}`),
  updateKeyResult: (id, data) => request('PATCH', `/key-results/${id}`, data),
  archiveKeyResult: (id) => request('DELETE', `/key-results/${id}`),
  checkIn: (id, data) => request('POST', `/key-results/${id}/check-ins`, data),
  checkInHistory: (id) => request('GET', `/key-results/${id}/check-ins`),
  setKeyResultHealth: (id, health, reason) => request('POST', `/key-results/${id}/health`, { health, reason }),
  keyResultTasks: (id) => request('GET', `/key-results/${id}/tasks`),
  ...
  accountStages: (params) => request('GET', `/accounts/stages${qs(params)}`),
  createAccountStage: (data) => request('POST', '/accounts/stages', data),
  updateAccountStage: (id, data) => request('PATCH', `/accounts/stages/${id}`, data),
  accounts: (params) => request('GET', `/accounts${qs(params)}`),
